...
public class ArtistRepository {
    ...
    public void load() {
        ...
        if (file.exists()) {
            try(FileInputStream foz = new FileInputStream(SAVE_PATH)) {
                ObjectInputStream oz = new ObjectInputStream(foz);
                this.artistMap = (Map<String, Artist>) oz.readObject();
            }catch (Exception e){
                e.printStackTrace();
            }
        }
