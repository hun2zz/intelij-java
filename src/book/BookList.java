...
public class BookList {
    ...
    BookList() {
        this.mArr = new Book[0];
    }
    // 맨 끝에 추가
    void push(Book newMember) {
        Book[] temp = new Book[mArr.length + 1];
...
//    }
    ...
    Book pop() {
        // 맨 끝 회원 백업
        Book lastMember = mArr[mArr.length - 1];
        Book[] temp = new Book[mArr.length - 1];
...
//    BookUser remove(BookUser deleteMember) {
